...
snakemake <- Snakemake(
    input = list('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/RNA_counts/groups/Genentech.txt', '/home/kgoldmann/Documents/PEAC_eqtl/Outputs/gene_coord.txt', '/home/kgoldmann/NAS/GCPEAC/Kevin/PEAC-eQTL/KevinAnalysis/ApocritaHPC/PEAC/imputed_vcf/PEAC_1000G_Phase3_Oct14_chr22.vcf.gz', "counts" = c('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/RNA_counts/groups/Genentech.txt'), "genecoord" = '/home/kgoldmann/Documents/PEAC_eqtl/Outputs/gene_coord.txt', "vcf" = c('/home/kgoldmann/NAS/GCPEAC/Kevin/PEAC-eQTL/KevinAnalysis/ApocritaHPC/PEAC/imputed_vcf/PEAC_1000G_Phase3_Oct14_chr22.vcf.gz')),
    output = list(),
...
# gene = as.character(gns$gene_id[gns$chrom==22])[1]
# 
# chr=22
# 
# snps=5e-5
