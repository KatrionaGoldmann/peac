...
snakemake <- Snakemake(
    ...
    output = list('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/deseq2/inputs/ENSG00000025708.rds', "in_deseq" = '/home/kgoldmann/Documents/PEAC_eqtl/Outputs/deseq2/inputs/ENSG00000025708.rds'),
    ...
    wildcards = list('ENSG00000025708', "gene" = 'ENSG00000025708'),
    threads = 1,
    log = list(),
    resources = list(),
...
in.deseq2(gene=snakemake@params[['gene']],
