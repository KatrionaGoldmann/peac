...
snakemake <- Snakemake(
    input = list('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/RNA_counts/groups/Genentech.txt', '/home/kgoldmann/Documents/PEAC_eqtl/Outputs/gene_coord.txt', '/home/kgoldmann/NAS/GCPEAC/Kevin/PEAC-eQTL/KevinAnalysis/ApocritaHPC/PEAC/imputed_vcf/PEAC_1000G_Phase3_Oct14_chr21.vcf.gz', "counts" = c('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/RNA_counts/groups/Genentech.txt'), "genecoord" = '/home/kgoldmann/Documents/PEAC_eqtl/Outputs/gene_coord.txt', "vcf" = '/home/kgoldmann/NAS/GCPEAC/Kevin/PEAC-eQTL/KevinAnalysis/ApocritaHPC/PEAC/imputed_vcf/PEAC_1000G_Phase3_Oct14_chr21.vcf.gz'),
    output = list('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/deseq2/inputs/ENSG00000244294.rds', "in_deseq" = '/home/kgoldmann/Documents/PEAC_eqtl/Outputs/deseq2/inputs/ENSG00000244294.rds'),
    params = list('21', -55, 5, 0.9, 5, '/home/kgoldmann/Documents/PEAC_eqtl/Outputs/deseq2/inputs', "chrom" = '21', "snps" = -55, "nhets" = 5, "tag" = 0.9, "missing" = 5, "out" = '/home/kgoldmann/Documents/PEAC_eqtl/Outputs/deseq2/inputs'),
    wildcards = list('ENSG00000244294', "gene" = 'ENSG00000244294'),
    threads = 1,
    log = list(),
    resources = list(),
