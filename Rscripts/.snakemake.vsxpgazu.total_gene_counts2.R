...
snakemake <- Snakemake(
    input = list('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/b37_ebg.rds', '/media/d1/STAR/Paired/SAM24298100/Aligned.sortedByCoord.out.bam'),
    output = list('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/RNA_counts/SAM24298100.txt'),
    params = list('Union', 'TRUE', "mode" = 'Union', "ignore_strand" = 'TRUE'),
    wildcards = list('SAM24298100', "sample" = 'SAM24298100'),
    threads = 1,
    log = list(),
    resources = list(),
