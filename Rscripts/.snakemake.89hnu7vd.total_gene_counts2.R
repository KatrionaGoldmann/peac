...
snakemake <- Snakemake(
    input = list('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/b37_ebg.rds', '/media/d1/STAR/Paired/SAM24298049/Aligned.sortedByCoord.out.bam'),
    output = list('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/RNA_counts/SAM24298049.txt'),
    params = list('Union', 'TRUE', "mode" = 'Union', "ignore_strand" = 'TRUE'),
    wildcards = list('SAM24298049', "sample" = 'SAM24298049'),
    threads = 1,
    log = list(),
    resources = list(),
