...
snakemake <- Snakemake(
    input = list('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/b37_ebg.rds', '/media/d1/STAR/Paired/SAM9103837/Aligned.sortedByCoord.out.bam'),
    output = list('/home/kgoldmann/Documents/PEAC_eqtl/Outputs/RNA_counts/SAM9103837.txt'),
    params = list('Union', 'TRUE', "mode" = 'Union', "ignore_strand" = 'TRUE'),
    wildcards = list('SAM9103837', "sample" = 'SAM9103837'),
    threads = 1,
    log = list(),
    resources = list(),
